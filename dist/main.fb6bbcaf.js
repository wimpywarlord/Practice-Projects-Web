...
populateUI();
var ticketPrice = movieSelect.value; // SET MOV IE DATA FUNCTION , SAVE SELECTED MOVIE INDEX
...
function updateSelectedCount() {
  var selectedSeats = document.querySelectorAll(".row .seat.selected"); // copy selected seats into arr
  // Map through array
  ...
  var selectedSeatsCount = selectedSeats.length; // console.log(selectedSeatsCount);
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "11061" + '/');
